/*
  ...
  1. Schema Changes
    ...
    - Create referral_links table for hotel operators to generate referral codes
    - Create referrals table to track bookings made through referral links
    - Create commissions table to track earnings from referrals
  
  2. Functions and Triggers
    - Add function to generate unique referral codes
    - Add trigger to create default referral link for new hotel operators
    - Add trigger to calculate commission when a referral is created
*/
