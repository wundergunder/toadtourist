...
DROP POLICY IF EXISTS "Territory managers can view hotel operators in their territory" ON profiles;
DROP POLICY IF EXISTS "Territory managers can update hotel operators in their territory" ON profiles;

-- Add policies for territory managers to manage hotel operators
CREATE POLICY "Territory managers can manage hotel operators"
ON profiles
FOR ALL
TO authenticated
USING (
