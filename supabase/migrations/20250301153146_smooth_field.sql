/*
  # Initial schema setup for Lazy Toad

  1. New Tables
    - `territories` - Stores information about travel destinations
    - `profiles` - User profiles with roles (admin, territory_manager, tour_guide, tourist)
    - `experiences` - Tours and activities offered in territories
    - `bookings` - Reservations made by tourists
    - `reviews` - Feedback from tourists about experiences
