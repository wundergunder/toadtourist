...
-- Insert initial admin user (will need to be updated with actual values)
INSERT INTO profiles (id, email, full_name, role)
VALUES ('00000000-0000-0000-0000-000000000000', 'admin@toadtourism.com', 'Admin User', 'admin')
